<?php
    ...
    echo '
        <div class="alert alert-danger text-center">
            <small>
                <b>PENTING! Menghapus komponen biaya pendidikan akan menyebabkan tagihan dan riwayat pembayaran tidak terdefinisikan</b><br>
                Apakah anda yakin akan menghapus data komponen biaya tersebut?
            </small>
        </div>
        <script>
            $("#button_hapus_multiple").prop("disabled", false);
        </script>
    ';
