<?php
    ...
    echo '
        <div class="row mb-2">
           <div class="col-12">
                <label for="tarif_multiple"><small>Periode Tahun</small></label>
                <input type="text" class="form-control form-money" name="tarif_multiple" id="tarif_multiple">
        ...
        <script>
            $("#button_edit_tarif_multiple").prop("disabled", false);
        </script>
    ';
