<?php
    ...
    echo '
        <div class="row mb-2">
           <div class="col-12">
                <label for="kategori_multiple"><small>Kategori</small></label>
                <select name="kategori_multiple" id="kategori_multiple" class="form-control">
        ...
        <script>
            $("#button_edit_kategori_multiple").prop("disabled", false);
        </script>
    ';
