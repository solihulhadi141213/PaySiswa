<?php
    ...
    if (!$Qry->execute()) {
        ...
        $fee_nominal            =round($Data['fee_nominal']);
        $fee_discount           =round($Data['fee_discount']);
        ...
        //Tampilkan Data
        echo '
            <input type="hidden" name="id_fee_by_student" class="form-control" value="'.$id_fee_by_student.'">
            <div class="row mb-2">
            ...
            <div class="row mb-2">
                ...
                <div class="col-1"><small>:</small></div>
                <div class="col-7">
                    <input type="text" class="form-control form-money" name="fee_nominal" id="fee_nominal_edit" value="'.$fee_nominal.'">
                </div>
            </div>
            <div class="row mb-2">
                <div class="col-4">
                ...
                <div class="col-1"><small>:</small></div>
                <div class="col-7">
                    <input type="text" class="form-control form-money" name="fee_discount" id="fee_discount_edit" value="'.$fee_discount.'">
                </div>
            </div>
        ';
    }
