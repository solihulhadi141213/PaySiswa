<?php
    ...
    if (!$Qry->execute()) {
        ...
        echo '
                <div class="col-4">
                    <label for="id_organization_class_edit">
                        <small>Kelas</small>
                    </label>
                </div>
        ';
        echo '  <div class="col-8">';
        echo '      <select name="id_organization_class" id="id_organization_class_edit" class="form-control">';
        echo '          <option value="">Pilih</option>';
                        ...
                        while ($data_level = mysqli_fetch_array($query_level)) {
                            ...
                            while ($data_kelas = mysqli_fetch_array($query_kelas)) {
                                ...
                                if($id_organization_class_list==$id_organization_class){
                                    echo '<option selected value="'.$id_organization_class_list.'">'.$class_level.'-'.$class_name.'</option>';
                                }else{
