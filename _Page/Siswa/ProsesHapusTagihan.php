<?php
    ...
    // --- PROSES HAPUS ---
    $ProsesHapusTagihan = mysqli_query($Conn, "DELETE FROM fee_by_student WHERE id_fee_by_student='$id_fee_by_student'") or die(mysqli_error($Conn));
    if ($ProsesHapusTagihan) {
        echo json_encode([
            'status' => 'success',
